...
//        ->add(Html::raw('HEADER')->addParentClass('header'))
        ->add(Link::toUrl(route('admin.index'), '<i class="fa fa-home"></i><span>  Home</span>'))
...
//        #adminlte_menu
        ...
        ->add(Link::toUrl(route('admin.books.index'), '<i class="fa fa-book"></i><span>  Books</span>'))
        ->add(Link::toUrl(route('admin.authors.index'), '<i class="fa fa-users"></i><span>  Authors</span>'))
        ->add(Link::toUrl(route('admin.comments.index'), '<i class="fa fa-comments-o"></i><span>  Comments</span>'))
        ->add(Link::toUrl(route('admin.genres.index'), '<i class="fa fa-list-alt"></i><span>  Genres</span>'))
